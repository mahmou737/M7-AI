...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-[#0b0d10] text-[#f8fafc] px-4 py-8 relative">
      <div className="w-full max-w-md bg-card/70 border border-white/10 backdrop-blur-2xl p-6 sm:p-8 rounded-3xl shadow-2xl relative z-10">
        <button
          onClick={() => navigate("/login")}
          className="flex items-center gap-2 text-xs font-semibold text-slate-400 hover:text-white transition-colors mb-6 p-1 rounded-lg"
        >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pr-10 bg-black/40 border-white/10 h-11 text-sm"
                  required
                />
              </div>
            </div>
